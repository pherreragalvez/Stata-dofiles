...
bys folio : egen _menor=count(folio) if edad <18
replace _menor=0 if _menor==.
bys folio : egen den_menor=count(folio)
...
rename v12 viv_sit
rename v16 viv_compra_c_subsidio
rename v30 viv_qhogares
rename v33 viv_razon_compartir
*viv_sit viv_compra_c_subsidio viv_qhogares viv_razon_compartir
*label list v12 v16 v30 v33
*br v12 v16 v30 v33
...
label drop LABAN region

cd "$data"
save "casen hogares 2015.dta", replace
